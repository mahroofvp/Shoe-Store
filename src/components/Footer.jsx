    ...
    <footer className='bg-theme pt-7 pb-5' >
        <div className='nike-container text-slate-200'> 
            ...
            max-w-2xl w-full m-auto md:max-w-none md:gap-5'>
                {titles.map((val, i)=>(
                    <div key={i} className=' grid items-center'>
                        ...
                        md:text-sm uppercase font-semibold'
                        >{val.title}</h1>
                    </div>
                ))}
                {links.map((list, i)=>(
            ...
            <div className=' mt-5 text-center'>
                ...
                >Copyright<sup className=' text-base font-bold'>&copy;</sup> ALL Reserved Rights 2023 <span className=' font-semibold'>Mahrf's</span></p>
            </div>
        </div>
    </footer>
    </>
