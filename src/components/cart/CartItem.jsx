...
import { setCartItemDecrement, setCartItemIncrement, setRomoveItemFromCart } from '../../Redux/CartSlice'
...
const CartItem = ({ item: { id, title, text, img, color, shadow, price, cartQuantity } }) => {
  ...
  const onRemoveItem =()=>{
   const item = {id, title}
    dispatch(setRomoveItemFromCart(item))
  }
  const onIncreaseItemQty = ()=>{
   dispatch(setCartItemIncrement({id}))
  }
  const ondecreaseItemQty = ()=>{
   dispatch(setCartItemDecrement({id}))
  }
    ...
    <>
      <div className=' flex items-center justify-between w-full px-5 '>
         ...
         transition-all duration-75 ease-in-out grid items-center`}>
          ...
          <div className='grid items-center gap-4 '>
            ...
            <div className='flex items-center justify-around w-full '>
              <button type='button' onClick={ondecreaseItemQty} className='bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 
              ...
              <button type='button' onClick={onIncreaseItemQty} className='bg-theme-cart rounded w-6
               h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90' >
        ...
        <div className='grid items-center gap-5'>
          ...
          <div className='grid items-center justify-center'>
             <button onClick={()=>onRemoveItem()} type='button' className='bg-theme-cart rounded p-1 lg:p-0.5 
