...
const { title, subtitle, btntext, img, sociallinks, videos} = homeapi
const Home = () => {
  return (
    <>
    <div className='relative h-auto w-auto flex flex-col'>
        <div className='bg-theme clip-path 
        h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] 
        w-auto absolute top-0 left-0 
        ...
        <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container  '>
          <div className=' grid items-center justify-items-center mt-28 md:mt-24 '>
            ...
            md:gap-3 absolute top-[33vh] lg:top-[36vh] left-[7%] xl:left-0 w-auto h-auto '>
              {videos?.map((val, i)=> (
